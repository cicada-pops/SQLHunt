# Generated by Django 4.2.20 on 2025-05-23 07:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('подтверждено', 'Подтверждено'), ('неподтверждено', 'Неподтверждено'), ('ложное', 'Ложное')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('в розыске', 'В розыске'), ('арестован', 'Арестован'), ('освобожден', 'Освобожден'), ('выпущен под залог', 'Выпущен под залог')], max_length=21)),

...
class SilverKey(BaseCase):
    ...
    description = (
       """
        1998 год. На окраине города в мотеле «Серебряный Ключ» планировалась тайная встреча между контрабандистами, но что-то пошло не так. Один из ключевых участников исчез, а в номере найдены следы борьбы и брошенный диктофон с записанным обрывком фразы:  ”…если он узнает про сделку в Роттердаме — всё пойдет прахом.”\n
